...
export const metadata = {
  ...
  description:
    "Temukan berbagai layanan premium DigimetaShop untuk semua kebutuhan buku digital Anda. Ebook PDF, Kindle, Mobi dengan harga terjangkau.",
};
      ...
      <section className="py-20 bg-gradient-to-br from-primary-light/30 to-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto">
            Temukan berbagai layanan premium kami untuk memenuhi semua kebutuhan
            bacaan digital Anda
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600">
              Pilihan lengkap untuk semua kebutuhan buku digital Anda
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600">
              Lebih dari 5000+ judul dalam berbagai kategori
            </p>
          </div>
          <div className="grid md:grid-cols-4 gap-6">
            <a
              href="https://www.tiktok.com/@ibuibu_digiital"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 glass-effect rounded-2xl text-center hover-lift cursor-pointer transition-all duration-300 hover:shadow-xl"
            >
            ...
            <a
              href="https://www.tiktok.com/@sofskillleadership"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 glass-effect rounded-2xl text-center hover-lift cursor-pointer transition-all duration-300 hover:shadow-xl"
            >
            ...
            <a
              href="https://www.tiktok.com/@ebookfiksi.id"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 glass-effect rounded-2xl text-center hover-lift cursor-pointer transition-all duration-300 hover:shadow-xl"
            >
            ...
            <a
              href="https://www.tiktok.com/@codingdeveloper.id"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 glass-effect rounded-2xl text-center hover-lift cursor-pointer transition-all duration-300 hover:shadow-xl"
            >
            ...
            <a
              href="https://www.tiktok.com/@digimeta007.com"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 glass-effect rounded-2xl text-center hover-lift cursor-pointer transition-all duration-300 hover:shadow-xl"
            >
            ...
            <a
              href="https://www.tiktok.com/@ebookhidupsehat"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 glass-effect rounded-2xl text-center hover-lift cursor-pointer transition-all duration-300 hover:shadow-xl"
            >
            ...
            <a
              href="https://www.tiktok.com/@parentwise.id"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 glass-effect rounded-2xl text-center hover-lift cursor-pointer transition-all duration-300 hover:shadow-xl"
            >
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600">
              Nikmati buku berkualitas dengan harga yang ramah di kantong
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-8 glass-effect rounded-2xl text-center hover-lift">
              ...
              <Link
                href="/payment"
                className="block w-full py-3 bg-primary hover:bg-primary-dark text-slate-900 rounded-full font-semibold transition-all duration-300"
              >
                Pesan Sekarang
              </Link>
            </div>
            <div className="p-8 glass-effect rounded-2xl text-center hover-lift border-2 border-primary">
              <div className="bg-primary text-slate-900 px-4 py-1 rounded-full text-sm font-semibold mb-4">
                POPULER
              </div>
