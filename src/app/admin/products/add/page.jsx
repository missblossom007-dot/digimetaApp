    ...
    <section className="py-16 bg-slate-50 min-h-screen">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600">Tambahkan produk baru secara manual</p>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-md p-6 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                name="slug"
                value={formData.slug}
                className="w-full p-3 border-2 border-slate-200 rounded-lg bg-slate-50"
                readOnly
              />
            </div>
